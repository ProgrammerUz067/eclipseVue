...
<template>
  ...
  <div class="heroSubP"><p>Introducing</p></div>
  <div class="hero">
    <div class="heroT">
      <h2>Eclipx</h2>
      <h2>Eclipx</h2>
  ...
  <div class="content-section">
    ...
    <p class="subp">
      At the core lies our revolutionary framework, <br />ensuring adaptability
      across all application architectures.
    </p>
  </div>
</template>
<script setup></script>
